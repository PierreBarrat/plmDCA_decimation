...
ostream & Graph2::sample_from_distribution_montecarlo(ostream & os, size_t m, size_t mc_iters0, size_t mc_iters, string const & out_energies_name)
{
	size_t ts = 0;
	vector<size_t> conf(n);
	for (size_t i = 0; i < n; ++i) {
